...
#import "DWBaseAppDelegate.h"

@implementation DWBaseAppDelegate

+ (instancetype)sharedAppDelegate {
    
    DWBaseAppDelegate *delegate = (DWBaseAppDelegate *)[UIApplication sharedApplication].delegate;
    return delegate;
}
...
{
    if (vc.navigationController != DWBaseAppDelegateInstance.navigationViewController)
    {
